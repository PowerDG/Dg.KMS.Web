...
{
    public class KMSDbMigrationService : ITransientDependency
    {
        public ILogger<KMSDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IKMSDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public KMSDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IKMSDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<KMSDbMigrationService>.Instance;
        }
